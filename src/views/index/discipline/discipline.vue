  ...
  <div class="qie">
    ...
    <el-card class="box-card">
      <el-form ref="form" :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-button @click="Add" icon="el-icon-plus" type="primary">新增学科</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    <!-- 下面一个卡片 -->
    <el-card class="box-card1">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="date" label="操作" v-if="['超级管理员', '管理员', '老师'].includes($store.state.Role)">
          <template slot-scope="scope">
            ...
            <el-button @click="dels(scope.row.id)" size="mini" type="text"  v-if="['超级管理员', '管理员'].includes($store.state.Role)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
    ...
    <disciplineCom ref="disciplineCom"></disciplineCom>
  </div>
</template>

<script>
// 导入编辑组件
// import disciplineCom from "./components/disciplineCom";
// 导入新增学科组件
// import disciplineCom from "./components/disciplineCom";
...
export default {
  ...
  methods: {
    // 点击新增
    Add() {
      this.$refs.disciplineCom.dialogFormVisible = true;

      this.$refs.disciplineCom.isCom = true;

      // this.$refs.disciplineCom.cz();

      this.$refs.disciplineCom.form = {};
    },
    // 点击编辑
    editBj(item) {
      // window.console.log(item);
      this.$refs.disciplineCom.dialogFormVisible = true;
      this.$refs.disciplineCom.isCom = false;
      ...
      if (item != this.oldItem) {
        ...
        // this.$refs.disciplineCom.form =item
