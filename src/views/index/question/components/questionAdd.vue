<template>
  <div class="box">
    <el-dialog destroy-on-close fullscreen title="新增题库测试" :visible.sync="dialogFormVisible">
      <el-form ref="form" :model="form" :rules="rules">
        ...
        <el-form-item
          ...
          :label-width="formLabelWidth"
        >
          <wangeditor2 v-model="form.answer_analyze"></wangeditor2>
        </el-form-item>
...
import wangeditor2 from "./wangeditor2";
