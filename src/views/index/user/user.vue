    ...
    <el-card class="box-card">
      <el-form ref="form" :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-button @click="Add" icon="el-icon-plus" type="primary">新增用户</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    <!-- 下面一个卡片 -->
...
<script>
import { user, status, remove } from "@/api/user.js";
...
export default {
  ...
  methods: {
    ...
    Add() {
      ...
      // this.$refs.userCom.cz();
      // window.console.log(this.$refs.userCom.form);
